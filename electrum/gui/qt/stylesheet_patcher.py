...
"""
CUSTOM_PATCH_FOR_DEFAULT_THEME_WINDOWS = r"""
/* ===== Frencoin Futuristic Theme (Green-forward, Blue secondary) =====
   Palette:
     - bg0: #0A0E12 (deep black-blue)
     - bg1: #0E141B
...
"""
CUSTOM_PATCH_FOR_DEFAULT_THEME_MACOS = r"""
/* ===== Frencoin Futuristic Theme (Green-forward, Blue secondary) =====
   Palette:
     - bg0: #0A0E12 (deep black-blue)
     - bg1: #0E141B
...
def patch_qt_stylesheet(use_dark_theme: bool = True, app: Optional[object] = None) -> None:
    ...
    qss = CUSTOM_PATCH_FOR_DARK_THEME if use_dark_theme else _choose_default_qss()
